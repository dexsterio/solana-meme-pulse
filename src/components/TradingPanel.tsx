  ...
  return (
    <div className="flex flex-col h-full bg-card rounded-lg border border-border overflow-y-auto overflow-x-hidden">
      ...
      <div className="px-3 py-3 border-b border-border space-y-2.5">
        <div className="flex items-center gap-2 bg-secondary rounded-md border border-border px-3 py-2.5">
          <span className="text-sm text-muted-foreground uppercase tracking-wide">Amount</span>
          <input
            type="text"
            value={amount}
            onChange={(e) => setAmount(e.target.value)}
            className="flex-1 bg-transparent text-base font-bold text-foreground outline-none text-right"
          />
          <SolanaIcon size={16} />
          <Menu className="w-4 h-4 text-muted-foreground cursor-pointer" />
        </div>
        <div className="flex gap-1.5">
          ...
          <button className="px-2.5 py-2 rounded bg-secondary border border-border text-muted-foreground hover:text-foreground">
